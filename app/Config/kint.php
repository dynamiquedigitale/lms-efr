 ...
 * ------------------------------------------------- -------------------------
 *
 * Nous utilisons `RichRenderer` et `CLIRenderer`. Cette section contient les 
 * options que vous pouvez modifier pour personnaliser la facon dont vous voulez
 * que KINT fonctionne pour vous
 * 
