            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                <li class="nav-item dropdown dropdown-language">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
						...
						<a class="dropdown-item" href="#" data-language="fr"><i class="flag-icon flag-icon-fr"></i> Français</a>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown dropdown-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <Link class="dropdown-item" :href="route('profil')">
							<i class="me-50" data-feather="user"></i>
							{{  $t('Profil') }}
						</Link>
						<div class="dropdown-divider"></div>
                        <Link class="dropdown-item" :href="route('parametres')">
							<i class="me-50" data-feather="settings"></i> 
							{{ $t('Paramètres') }}
						</Link>
						<b-link class="dropdown-item" :href="route('logout')">
